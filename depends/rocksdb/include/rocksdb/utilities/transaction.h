...
class Transaction {
 public:
  ...
  //virtual void SetSafeSnapshot(const int64_t seq) = 0;
  virtual void SetSnapshotWithTS(const SequenceNumber seq) = 0;
  ...
  virtual Status CommitWithTS(const SequenceNumber commit_ts) = 0;
  virtual Status CommitWithLTS(const SequenceNumber commit_ts, const uint32_t lts) = 0;
  ...
  virtual Status Get(const ReadOptions& options,
                     ColumnFamilyHandle* column_family, const Slice& key,
                     std::string* value, uint64_t *cts, uint64_t *nts) = 0;
  ...
  virtual Status Get(const ReadOptions& options,
    ...
    auto s = Get(options, column_family, key, pinnable_val->GetSelf(), cts, nts);
  ...
  virtual Status GetForUpdate(const ReadOptions& options,
                              ...
                              bool exclusive = true, uint64_t *cts = nullptr, uint64_t *nts = nullptr) = 0;
  ...
  virtual Status GetForUpdate(const ReadOptions& options,
                              ...
                              bool exclusive = true, uint64_t *cts = nullptr, uint64_t *nts = nullptr) {
    if (pinnable_val == nullptr) {
      std::string* null_str = nullptr;
      return GetForUpdate(options, column_family, key, null_str, exclusive, cts, nts);
    } else {
      auto s = GetForUpdate(options, column_family, key,
                            pinnable_val->GetSelf(), exclusive, cts, nts);
      pinnable_val->PinSelf();
      return s;
    }
  }
  ...
  virtual Status GetForUpdate(const ReadOptions& options, const Slice& key,
                              std::string* value, bool exclusive = true, uint64_t *cts = nullptr, uint64_t *nts = nullptr) = 0;
  ...
  virtual void SetCommitTS(const uint64_t commit_ts_) = 0;

  virtual uint64_t GetCommitTS() const = 0;
