...
extern ROCKSDB_LIBRARY_API void rocksdb_iter_ts(rocksdb_iterator_t* iter, uint64_t *cts, uint64_t *nts);
...
extern ROCKSDB_LIBRARY_API void rocksdb_readoptions_set_sequence(
    rocksdb_readoptions_t* opt, const uint64_t sequence);
...
extern ROCKSDB_LIBRARY_API void rocksdb_transaction_commit_with_ts(
    rocksdb_transaction_t* txn, char** errptr, uint64_t commit_ts);

extern ROCKSDB_LIBRARY_API void rocksdb_transaction_commit_with_lts(
    rocksdb_transaction_t* txn, char** errptr, uint64_t commit_ts, uint32_t lts);
...
extern ROCKSDB_LIBRARY_API char* rocksdb_transaction_get_ts(
    rocksdb_transaction_t* txn, const rocksdb_readoptions_t* options,
    const char* key, size_t klen, size_t* vlen, uint64_t *cts, uint64_t *nts, char** errptr);

extern ROCKSDB_LIBRARY_API char* rocksdb_transaction_get_cf_ts(
    rocksdb_transaction_t* txn, const rocksdb_readoptions_t* options,
    rocksdb_column_family_handle_t* column_family, const char* key, size_t klen,
    size_t* vlen, uint64_t *cts, uint64_t *nts, char** errptr);
...
extern ROCKSDB_LIBRARY_API char* rocksdb_transaction_get_for_update_ts(
    rocksdb_transaction_t* txn, const rocksdb_readoptions_t* options,
    const char* key, size_t klen, size_t* vlen, unsigned char exclusive, uint64_t *cts, uint64_t *nts,
    char** errptr);
...
extern ROCKSDB_LIBRARY_API char* rocksdb_transactiondb_get_ts(
    rocksdb_transactiondb_t* txn_db, const rocksdb_readoptions_t* options,
    const char* key, size_t klen, size_t* vlen, uint64_t *cts, uint64_t *nts, char** errptr);

extern ROCKSDB_LIBRARY_API char* rocksdb_transactiondb_get_cf_ts(
    rocksdb_transactiondb_t* txn_db, const rocksdb_readoptions_t* options,
    rocksdb_column_family_handle_t* column_family, const char* key,
    size_t keylen, size_t* vallen, uint64_t *cts, uint64_t *nts, char** errptr);
...
extern ROCKSDB_LIBRARY_API rocksdb_transaction_t* 
rocksdb_optimistictransaction_begin_with_ts(
    rocksdb_optimistictransactiondb_t* otxn_db,
    const rocksdb_writeoptions_t* write_options,
    const rocksdb_optimistictransaction_options_t* otxn_options,
    rocksdb_transaction_t* old_txn,
