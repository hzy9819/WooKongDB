...
class WritePreparedTxn : public PessimisticTransaction {
 ...
 private:
  ...
  Status CommitWithoutPrepareInternalWithTS(SequenceNumber commit_ts, uint32_t lts) override;
  ...
  Status CommitInternalWithTS(SequenceNumber commit_ts, uint32_t lts) override;
